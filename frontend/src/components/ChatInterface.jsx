...
// function ChatInterface({ sessionId, setSessionId, setGlobalMoodData, user, sessionManager }) {
...
//   // **UPDATED: Voice Recognition Setup with 5 commands**
//   const commands = [
//     {
...
//     console.log('🔄 Clearing chat session completely...');
...
//     // Re-initialize chat after clearing
//     setTimeout(() => {
//       initializeChat();
//     }, 100);
//   }, [initializeChat, resetTranscript]);
...
//             {/* **UPDATED: Enhanced Voice Status with available commands** */}
//             {isVoiceMode && (
...
//               {/* **UPDATED: Instructions with all 5 voice commands** */}
